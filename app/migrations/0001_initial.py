    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('готов', 'Готов'), ('в разработке', 'В разработке')], default='в разработке', max_length=20, verbose_name='Статус')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(blank=True, default=app.models.get_datetime, null=True, validators=[app.models.check_date_created], verbose_name='created')),
                ('name', models.TextField(verbose_name='name')),
                ('developers', models.ManyToManyField(related_name='team_developer', to='app.developer')),
            ],
            options={
                'verbose_name': 'team',
